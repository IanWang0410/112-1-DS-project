...
/*
 * This class is a direct copy of HW
 * This class will not be used
 * It is kept as a reference to develop the actual webTree that will be used
 */
public class WebTree_Ori {
    public WebNode root;

    public WebTree_Ori(Webs rootPage) {
    ...
    private void eularPrintTree(WebNode startNode) {
        ...
        System.out.print("(");
        System.out.print(startNode.web.getTitle() + "," + startNode.nodeScore);
